	...
	public class FTDI
	{
		...
		public FTDI()
		{
			...
			if (hFTD2XXDLL == IntPtr.Zero)
			{
				...
				hFTD2XXDLL = LoadLibrary(@"FTD2XX64.DLL");
				if (hFTD2XXDLL == IntPtr.Zero)
				{
					...
					MessageBox.Show("Attempting to load FTD2XX64.DLL from:\n" + Path.GetDirectoryName(GetType().Assembly.Location));
					hFTD2XXDLL = LoadLibrary(@Path.GetDirectoryName(GetType().Assembly.Location) + "\\FTD2XX64.DLL");
				}
			}
